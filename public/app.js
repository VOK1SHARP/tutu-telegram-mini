...
const teaCatalog = [
    ...
    },
    {
        ...
        description: 'Это особый вид пуэра с узнаваемым ароматом и вкусом клейкого риса.',
        effect: 'Энергия',
        details: {
    ...
    },
    {
        ...
        description: 'Шу пуэр 2018 года — это выдержанный чай из провинции Юньнань.',
        effect: 'Энергия',
        details: {
            weight: '50 г'
        },
    ...
    },
    {
        ...
        description: 'Это утёсный улун из провинции Фуцзянь, Китай.',
        effect: 'Антистресс',
        details: {
            weight: '50 г'
        },
    ...
    // Габа
    {
        ...
        description: 'Габа Мао Ча - это несортированный чай с повышенным содержанием гамма аминомасляной кислоты.',
        effect: 'От тревоги',
        details: {
            weight: '50 г'
        },
    ...
    // Красные чаи
    {
        ...
        icon: 'fas fa-crown',
        image: 'teas/red1.jpg',
        description: 'Премиальный красный чай из северной части провинции Фуцзянь (Китай).',
        effect: 'Гармония',
        details: {
            weight: '50 г'
        },
    ...
    },
    {
        ...
        image: 'teas/red2.jpg',
        description: 'Один из самых известных китайских красных чаёв.',
        effect: 'Антистресс',
        details: {
            weight: '50 г'
        },
    ...
    },
    {
        ...
        icon: 'fas fa-tree',
        image: 'teas/red3.jpg',
        description: 'Китайский красный чай, изготовленный из листьев древних чайных деревьев.',
        effect: 'От усталости',
        details: {
            weight: '50 г'
        },
    ...
    },
    {
        ...
        icon: 'fas fa-fire',
        image: 'teas/red4.jpg',
        description: 'По китайской классификации относится к красным чаям.',
        effect: 'Согревает',
        details: {
            weight: '50 г'
        },
    ...
    // Зеленые чаи
    {
        ...
        description: 'Один из самых известных китайских зелёных чаёв.',
        effect: 'Тонизирует',
        details: {
            weight: '50 г'
        },
    ...
    },
    {
        ...
        description: 'Это традиционный китайский чай с тысячелетней историей.',
        effect: 'Вдохновляет',
        details: {
            weight: '50 г'
        },
    ...
    // Белый чай
    {
        ...
        description: 'Белый чай с минимальной обработкой.',
        effect: 'Омолаживает',
        details: {
            weight: '50 г'
        },
