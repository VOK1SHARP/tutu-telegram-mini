...
Эффект: мягко бодрит, проясняет сознание, повышает концентрацию. Снимает напряжение, помогает обрести умиротворение после тяжёлого дня.`
    },
    {
        ...
        fullDescription: `Габа Мао Ча - это несортированный чай с повышенным содержанием гамма аминомасляной кислоты, прошедший особую ферментацию в бескислородной среде.
