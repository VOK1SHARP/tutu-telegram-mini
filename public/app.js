...
// Улучшенная функция открытия ссылок
function openTelegramLink(url) {
    console.log('Открываем ссылку:', url);
    
    // ВСЕ ССЫЛКИ ИДУТ НА @tea_tea_info
...
Эффект: Витамин B2 и антиоксиданты поддерживают эластичность кожи, уменьшают проявления воспалений и раздражений, замедляют возрастные изменения. Гун Мэй укрепляет иммунитет, благодаря высокому содержанию витамина C и полифенолов. Помогает организму противостоять вирусам и бактериям в сезон простуд.`
    ...
    // Набор (ИСПРАВЛЕННЫЙ - цена 500р и нет дублирования)
    {
        id: 15,
        ...
        type: 'Набор',
        category: 'sets',
        price: 500, // ИСПРАВЛЕНА ЦЕНА НА 500р
        icon: 'fas fa-gift',
            ...
            <div class="logo-container">
                <div class="logo-wrapper">
                    ...
                    <img src="logo.png" 
                         ...
                         style="max-width: 220px; height: auto; max-height: 80px; filter: drop-shadow(0 4px 12px rgba(0, 0, 0, 0.3));">
                    <!-- Fallback иконка -->
        ...
        <div class="main-content">
            ...
            <div class="quick-actions">
                ...
                <div class="action-buttons">
                    ...
                    <div class="action-btn" onclick="openTelegramLink('https://t.me/tea_tea_info')" style="cursor: pointer;" aria-label="Наш телеграм-канал">
...
${cart.map(item => `• ${item.name} × ${item.quantity} = ${item.price * item.quantity}₽`).join('\n')}`;
        ...
        const telegramUrl = `https://t.me/tea_tea_info?text=${encodedMessage}`; // ИСПРАВЛЕНА ССЫЛКА НА @tea_tea_info
    ...
    page.innerHTML = `
        ...
        <div class="page-body profile-body">
            ...
            <div class="profile-section">
                ...
                <div class="contact-list">
                    <div class="contact-item">
                        <i class="fab fa-telegram"></i>
                        <span>@tea_tea_info</span> <!-- ИСПРАВЛЕН НИК -->
                        <button onclick="openTelegramLink('https://t.me/tea_tea_info')" aria-label="Написать в поддержку">
                            Написать
                        </button>
                    </div>
            ...
            <div class="profile-actions">
                <button onclick="openTelegramLink('https://t.me/tea_tea_info')" class="profile-btn telegram-btn" aria-label="Перейти в наш телеграм-канал">
